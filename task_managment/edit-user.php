        ...
        <section class="section-1">
            ...
            <form class="form-1" method="POST" action="app/update-user.php">
                ...
                <div class="input-holder">
                    ...
                    <input type="text" name="user_name" class="input-1" placeholder="Username" value="<?= htmlspecialchars($user['username']) ?>"><br>
                </div>
                <div class="input-holder">
                    <label>Password</label>
                    <input type="password" name="password" class="input-1" placeholder="Password"><br>
                    <small>Leave empty if you don't want to change the password</small><br>
                </div>

                <!-- جعل الرقم التعريفي قابلًا للتعديل -->
                <div class="input-holder">
                    <label>User ID</label>
                    <input type="text" name="id" class="input-1" value="<?= htmlspecialchars($user['id']) ?>"><br>
                </div>
